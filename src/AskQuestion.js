    ...
    return (
        <div className="w-full md:w-10/12">
            ...
            <form className=" px-6 py-6">
                ...
                <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 ">Your Question</label>
                <textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 outline-none" placeholder="Type question...." required></textarea>
